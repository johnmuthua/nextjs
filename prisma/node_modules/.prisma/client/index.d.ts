...
export namespace Prisma {
  ...
  */
  ...
  type GetBlogPostGroupByPayload<T extends BlogPostGroupByArgs> = Promise<
    Array<
  ...
  export type BlogPostGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof BlogPost ?BlogPost [P]
  : 
     never
  } 
    : BlogPost
  ...
  export interface BlogPostDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, BlogPostGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBlogPostGroupByPayload<T> : Promise<InputErrors>
  }
